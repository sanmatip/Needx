...
<body style="background-color: #f2f2f2;">
 ...
 -->
				...
				<li class="dropdown" style="background-color: #b71c1c"><a
					class="dropdown-toggle" data-toggle="dropdown" href="#"
					style="color: white" id="t1">MY ACCOUNT <span class="caret"></span>
				</a>
					<ul class="dropdown-menu" style="background-color:#3b5998 ">
                               <li class="dropdown-submenu dropdown-menu-right">
                                  <a tabindex="-1" href="#" id="p1"  style="color: white">Profile</a>
                                  <ul class="dropdown-menu">
                                     <li>
                                         <div  class="inl" align="left" style="margin:10px 10px;">
                                             <!-- <img class="img-circle" src="http://www.gravatar.com/avatar/f6112e781842d6a2b4636b35451401ff?s=125" width="50px" height="55px"></img> -->
                                             <%-- <img src="<%=profile.getImagePath()%>"> --%>
                                             <%-- <img class='imagem_artigo' src="data:image;base64,${requestScope.convertedimage}" alt="Image Description" width="50px" height="55px"></img> --%>
                              ...
                              <li><a href="/NewProject/logout" id="l1"  style="color: white"> <i class="fa fa-fw fa-sign-out"></i>Logout</a></li>
                           </ul>
					</li>
				<li></li>
			</ul>
	...
	<div class="ib"
		style="width: 12%; height: 1000px; position: fixed; color: white; background-color: #f2f2f2;">
		<br> <a href="/NewProject/viewPost" style="color: #3b5998">Back
			to View Posts</a>
	</div>
	<div class="ib" style="margin-left: 16%">
		<br>
		<div class="panel panel-default"
			style="width: 600px; background-color: white;">
			<div class="panel-heading" id="d1">
				<b style="color: red; font-size: 24px"> <i
					class="fa fa-comments" style="color: #2B60DE"></i> All replies..
				</b>
			</div>
			<div class="panel-body">
				<c:forEach var="reply" items="${rList}">
					<div class="cmt">
						<font style="color: #3b5998">${reply.custName} :</font>
						${reply.reply}
					</div>
					<hr>
				</c:forEach>
		...
		<div class="l-srp__sidebar flex__item SRBanList">
			<div class="SkyScrapper">
				<div class="txt_align_rht">
					...
					<div
						style="border: 0px solid black; margin-top: 10px; width: 182px">
						<div class="banBlock" class="advertise">
							<div onclick="">
								<div class="imgBlk">
